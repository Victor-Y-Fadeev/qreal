...
#include "iotikEnginesBackwardBlock.h"
...
IotikEnginesBackwardBlock::IotikEnginesBackwardBlock(kitBase::robotModel::RobotModelInterface &robotModel)
	: EngineCommandBlock(robotModel)
{
}

void IotikEnginesBackwardBlock::run()
{
	...
	for (IotikMotor * const motor : parsePorts<IotikMotor>()) {
