...
#include "iotikEnginesForwardBlock.h"
...
IotikEnginesForwardBlock::IotikEnginesForwardBlock(kitBase::robotModel::RobotModelInterface &robotModel)
	: kitBase::blocksBase::common::EngineCommandBlock(robotModel)
{
}

void IotikEnginesForwardBlock::run()
{
