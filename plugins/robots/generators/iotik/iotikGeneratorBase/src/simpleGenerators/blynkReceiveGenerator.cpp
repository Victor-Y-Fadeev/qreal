...
#include "blynkReceiveGenerator.h"
...
BlynkReceiveGenerator::BlynkReceiveGenerator(const qrRepo::RepoApi &repo
		, generatorBase::GeneratorCustomizer &customizer
		, const Id &id
		, QObject *parent)
	: BindingGenerator(repo, customizer, id, "network/receive.t", QList<Binding *>()
