...
#include "waterSensorToVariableGenerator.h"
...
WaterSensorToVariableGenerator::WaterSensorToVariableGenerator(const qrRepo::RepoApi &repo
	...
	: BindingGenerator(repo, customizer, id,
					   ...
					   QList<Binding *>()
			<< Binding::createStatic("@@DRIVER@@", "WATER")
