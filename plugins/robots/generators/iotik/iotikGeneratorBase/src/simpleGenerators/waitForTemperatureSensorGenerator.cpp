...
#include "waitForTemperatureSensorGenerator.h"
...
WaitForTemperatureSensorGenerator::WaitForTemperatureSensorGenerator(const qrRepo::RepoApi &repo
	...
	: BindingGenerator(repo, customizer, id, "wait/analogPort.t", QList<Binding *>()
			...
			<< Binding::createConverting("@@VALUE@@", "Temperature"
					, customizer.factory()->intPropertyConverter(id, "Temperature"))
